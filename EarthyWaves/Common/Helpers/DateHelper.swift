...
enum CustomDateFormat: String {
    //HERE: Add your Custom date formats
    
    case geo = "yyyy-MM-dd HH:mm:ss"
...
class DateHelper {
    ...
    static func string(from date: Date, using format: CustomDateFormat = .server) -> String {
        let serverFormatter = DateFormatter()
        serverFormatter.dateFormat = CustomDateFormat.server.rawValue
        serverFormatter.locale = Locale.init(identifier: localePreferred)
        let utcServerDate = serverFormatter.string(from: date)
        let localFormatter =  DateFormatter()
        localFormatter.dateFormat = CustomDateFormat.database.rawValue
    ...
    static func formatStringFromLocal(from string: String, using format: CustomDateFormat = .server) -> String {
    ...
    static func date(from string: String, using format: CustomDateFormat = .geo, timeZone: String? = nil) -> Date? {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format.rawValue
    ...
    static func getDisplayDate(from date: Date) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = CustomDateFormat.display.rawValue
        dateFormatter.locale = Locale.init(identifier: localePreferred)
    ...
    static func getServerShortDate(from date: Date) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = CustomDateFormat.serverShort.rawValue
        dateFormatter.locale = Locale.init(identifier: localePreferred)
        return dateFormatter.string(from: date)
    }
    ...
    static func isDateToday(date: Date) -> Bool {
        let formattedDate = string(from: date, using: CustomDateFormat.display)
        let localFormatter =  DateFormatter()
        let currentDate = Date()
        localFormatter.dateFormat = CustomDateFormat.display.rawValue
    ...
    static func convertFromLocalToServer(from string: String?) -> String {
        ...
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = CustomDateFormat.server.rawValue
        dateFormatter.locale = Locale.init(identifier: localePreferred)
        return dateFormatter.string(from: originalDate)
    }
    ...
    static func convertServerToLocal(from string: String?) -> String {
        ...
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = CustomDateFormat.local.rawValue
        dateFormatter.locale = Locale.init(identifier: localePreferred)
        return dateFormatter.string(from: originalDate!)
    }
